...
def get_default_train_val_test_loader(args):
    ...
    # get dataset from .pt
    data_train  = torch.load(f'{dsid}/X_train.pt')
    # data_val    = torch.load(f'data/UCR/{dsid}/X_valid.pt')
    data_val    = torch.load(f'{dsid}/X_test.pt')
    
    label_train = torch.load(f'{dsid}/y_train.pt')
    # label_val   = torch.load(f'data/UCR/{dsid}/y_valid.pt')
    label_val   = torch.load(f'{dsid}/y_test.pt')
